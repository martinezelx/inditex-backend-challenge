    ...
    public CommandLineRunner initDatabase(PriceJpaRepository priceRepository) {
        return args -> {
            ...
            priceRepository.saveAll(Arrays.asList(
                    new PriceEntity(new Random().nextLong(), 1L, LocalDateTime.parse("2020-06-14-00.00.00", formatter),
                            LocalDateTime.parse("2020-12-31-23.59.59", formatter), 1, 35455L, 0, 35.50, "EUR"),
                    new PriceEntity(new Random().nextLong(), 1L, LocalDateTime.parse("2020-06-14-15.00.00", formatter),
                            LocalDateTime.parse("2020-06-14-18.30.00", formatter), 2, 35455L, 1, 25.45, "EUR"),
                    new PriceEntity(new Random().nextLong(), 1L, LocalDateTime.parse("2020-06-15-00.00.00", formatter),
                            LocalDateTime.parse("2020-06-15-11.00.00", formatter), 3, 35455L, 1, 30.50, "EUR"),
                    new PriceEntity(new Random().nextLong(), 1L, LocalDateTime.parse("2020-06-15-16.00.00", formatter),
